...
template void igl::adjacency_list<Eigen::Matrix<int, -1, -1, 1, -1, -1>, int>(Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 1, -1, -1> > const&, std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > >&, bool);
#endif
